...
function CTA({
  ...
  return (
    <div className={`cta ${sectionBg}`}>
      ...
      >
        <div className="cta-content flex flex-col gap-4 lg:gap-6 lg:items-start lg:text-left lg:mb-0 w-full lg:w-[40%] xl:w-[40%] 2xl:w-[30%]">
          <span className="cta-badge w-fit text-center bg-transparent py-2 border-2 border-(--primary-color) text-(--primary-color) text-[12px] font-semibold px-3 uppercase">
            {sectionBadge}
          </span>
          <h2
            className={`cta-title ${sectionTitleColor} text-[32px] sm:text-[38px] lg:text-[48px] font-medium leading-tight font-['Anton']`}
          >
            {sectionTitle}
          </h2>
          <p
            className={`cta-description ${sectionDescColor} text-[13px] sm:text-[14px] lg:text-[16px]`}
          >
            {sectionDesc}
          </p>
          <NavLink
