...
function Products() {
  ...
  // A page of results is a distinct set of products, so it self-canonicalises
  // with `?page=`. Sort, view and every filter facet are dropped: they reorder
  // the same catalogue, and pointing them all at the clean URL is what keeps
  // them from competing as duplicates.
  const canonical =
    currentPage > 1 ? `/products?page=${currentPage}` : "/products";

  // Internal search results are deliberately kept out of the index — they're an
  // unbounded set of thin pages generated by whatever visitors happen to type.
  ...
  const seoTitle = isSearch
    ...
    : currentPage > 1
      ...
      : "All Products — Wigs, Beauty & Skincare";
  ...
  return (
    <div className="products-page">
      <Seo
        ...
        description={
          isSearch
            ? `Products matching “${query}” at Zeedara.`
            : "Browse every Zeedara product — wigs and hair, beauty, makeup, skincare and personal care. Filter by category, brand and price, with naira pricing and secure checkout."
        }
        canonical={canonical}
        noindex={isSearch}
        jsonLd={
          // Structured data describes what's on the page, so it waits for the
          // products to arrive and is skipped entirely on a noindexed search.
      ...
      <div className={`mx-auto max-w-[1920px] ${sidePadding} py-8`}>
        ...
        <h1 className="mb-6 text-2xl font-semibold text-black">{heading}</h1>
