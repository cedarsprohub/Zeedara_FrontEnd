...
function CTA({
  ...
  return (
    <div className={`cta ${sectionBg} py-16`}>
      ...
      >
        <div className="cta-content flex flex-col gap-6 text-center items-center lg:items-start lg:text-left lg:mb-0 w-full lg:w-[40%] xl:w-[40%] 2xl:w-[30%]">
          <span className="cta-badge bg-transparent py-2 border border-(--primary-color) border-2 order w-fit text-(--primary-color) text-sm font-bold px-3">
            {sectionBadge}
          </span>
          <h2
          ...
          <NavLink
            to={sectionBtnLink}
            className="cta-button bg-(--primary-color) cursor-pointer text-white font-bold py-3 px-6 w-fit hover:bg-[#573b0f] transition-colors duration-300"
          >
            {sectionBtnText}
          </NavLink>
        </div>
